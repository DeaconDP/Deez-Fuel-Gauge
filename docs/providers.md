...
|----------|--------------------------|---------------------------|-------------------------|
| **Cursor** | Sign in to Cursor IDE on this machine — no API key needed | **Grok Bot weekly** allowance (Ultra / Premium) via the same login — shown with Cursor Models & Cursor API | — |
