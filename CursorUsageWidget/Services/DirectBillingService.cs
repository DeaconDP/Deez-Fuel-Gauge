...
public sealed class DirectBillingService : IDisposable
{
    ...
    {
        _ownsClients = openAi is null && codex is null && antigravity is null &&
                       openRouter is null && openCode is null;
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return CopyWithEnrichment(snapshot, openAiDirect, codex, antigravity, openRouter, openCode);
    }
